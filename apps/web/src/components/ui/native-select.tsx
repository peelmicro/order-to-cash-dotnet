...
// Local change to the vendored shadcn component: `wrapperClassName`. The
// wrapper is `w-fit` upstream, so a select inside a grid cell sized itself to
// its LONGEST option and overflowed its neighbour — the layout defect #7 found
// in a real browser (review_web_app.md Pass 4, Bug 2). Grid/form callers pass
