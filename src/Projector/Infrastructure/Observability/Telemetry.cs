...
namespace OrderToCash.Projector.Infrastructure.Observability;
...
{
    public const string SourceName = "OrderToCash.Projector";
...
{
    public const string MeterName = "OrderToCash.Projector";
...
/// <summary>design.md §9.2 — <c>OTEL_EXPORTER_OTLP_ENDPOINT</c>, read by <c>ProjectorProgramConfiguration.ConfigureTelemetry</c>.</summary>
...
/// <summary>
/// design.md §5.1 — registered from <c>ProjectorHost.CreateBuilder</c>
...
{
    public static IServiceCollection AddProjectorTelemetry(this IServiceCollection services, Action<TelemetryOptions> configure)
    {
        ...
        services.AddOpenTelemetry()
            .ConfigureResource(r => r.AddService(serviceName: "projector"))
            .WithTracing(t => t
