...
/// <summary>One durably-recorded ignored fact (design.md §5.4). <see cref="ObservedStatus"/> is populated for <see cref="SagaIgnoredFactMarker.PreconditionUnmet"/>; both it and <see cref="ExpectedStatus"/> are <see langword="null"/> for <see cref="SagaIgnoredFactMarker.UnknownOrder"/>, where <see cref="OrderId"/> is also <see langword="null"/>.</summary>
