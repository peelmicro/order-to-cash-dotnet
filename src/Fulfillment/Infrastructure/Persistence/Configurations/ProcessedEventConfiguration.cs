...
/// <summary>
/// `otc_fulfillment.processed_events` (Databases doc §4.3 — byte-identical
/// to `otc_orders`). Unique index `(event_id, consumer)` — a Kafka
/// redelivery of a fact already recorded here must be rejected, not
/// silently duplicated. Configuration copied verbatim from
