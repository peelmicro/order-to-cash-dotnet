...
/// <summary>
/// `otc_fulfillment.outbox` (Databases doc §4.3 — byte-identical to
/// `otc_orders`). Indexes: `(published_at, seq)` is the relay's poll index —
/// a range scan over the `NULL` prefix, already ordered;
...
/// parity test (feature db_billing) has an easy job.
/// </summary>
