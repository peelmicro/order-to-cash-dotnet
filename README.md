...
| 10 | Billing service | 🚧 `BuyerCredit` aggregate, the hold/release/consume ledger and the `billing.credit.*` responder done — and the outbox family is now byte-identical across all three services |
