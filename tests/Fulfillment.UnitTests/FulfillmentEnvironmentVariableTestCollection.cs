...
/// this, <see cref="FulfillmentDbContextFactoryTests"/> — which drives the
/// SAME <c>MSSQL_HOST</c>/<c>MSSQL_HOST_PORT</c>/<c>MSSQL_DB_FULFILLMENT</c>/
/// <c>MSSQL_APP_USER</c>/<c>MSSQL_APP_PASSWORD</c> variable names
/// <see cref="FulfillmentProgramConfigurationTests"/> already mutates —
...
public sealed class FulfillmentEnvironmentVariableTestCollection
{
    public const string Name = "Fulfillment environment variable tests";
}
