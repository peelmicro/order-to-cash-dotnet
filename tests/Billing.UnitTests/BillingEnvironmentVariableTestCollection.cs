...
/// this, <see cref="BillingDbContextFactoryTests"/> — which drives the SAME
/// <c>MSSQL_HOST</c>/<c>MSSQL_HOST_PORT</c>/<c>MSSQL_DB_BILLING</c>/
/// <c>MSSQL_APP_USER</c>/<c>MSSQL_APP_PASSWORD</c> variable names
/// <see cref="BillingProgramConfigurationTests"/> already mutates — would
...
public sealed class BillingEnvironmentVariableTestCollection
{
    public const string Name = "Billing environment variable tests";
}
