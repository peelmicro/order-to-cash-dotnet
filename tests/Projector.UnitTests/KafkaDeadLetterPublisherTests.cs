...
/// <c>ProjectorDeadLetterTests</c> only asserted PRESENCE of
...
public sealed class KafkaDeadLetterPublisherTests
{
    ...
    public async Task PublishAsync_RendersEveryDeadLetterHeaderValue_NotJustWhetherItParses()
    {
        ...
        Assert.Equal(ConsumerNames.ToToken(ConsumerName.Projector), headers["x-failed-consumer"]);
    ...
    private static DeadLetterPublication BuildPublication() =>
        new(
            ...
            FailedConsumer: ConsumerName.Projector,
            Attempts: 3,
            Error: "boom",
