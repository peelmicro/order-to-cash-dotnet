...
public sealed class SchemaColumnTypeTests(MsSqlContainerFixture fixture)
{
    ...
    [
        ...
        new("orders", "initial_amount", "int"),
        new("orders", "initial_discount", "int"),
        new("orders", "total_amount", "int"),
        ...
        new("order_items", "price", "int"),
        new("order_items", "quantity", "int"),
        new("order_items", "discount", "int"),
