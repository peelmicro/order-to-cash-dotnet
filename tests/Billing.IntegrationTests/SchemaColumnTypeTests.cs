...
public sealed class SchemaColumnTypeTests(MsSqlContainerFixture fixture)
{
    ...
    [
        ...
        new("credits", "credit_limit", "bigint"),
        ...
        new("credit_items", "amount", "bigint"),
        ...
        new("invoices", "amount", "bigint"),
        new("invoices", "discount", "bigint"),
        new("invoices", "total_amount", "bigint"),
        ...
        new("invoice_items", "price", "bigint"),
