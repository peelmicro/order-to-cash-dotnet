...
/// <c>otc.billing.facts.v1</c> topic with 6 partitions, RF 1 — never
/// auto-creation.
/// </summary>
public sealed class KafkaContainerFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        [
            new TopicSpecification { Name = BillingFactTopic.Name, NumPartitions = 6, ReplicationFactor = 1 },
        ]);
    }
...
/// <summary>A test needing BOTH real Kafka and real MS-SQL joins this collection — a SEPARATE MS-SQL container from <see cref="MsSqlCollection"/>'s, the shape Orders'/Fulfillment's own <c>KafkaCollection</c> already establishes.</summary>
